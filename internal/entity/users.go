...
type UserTokenDTO struct {
	...
	Username     string `json:"username" example:"Pantufla89" description:"Username"`
	Token        string `json:"accessToken" example:"eyJhbGciOiJ..." description:"token for API"`
	TokenSwagger string `json:"accessBearerToken" example:"Bearer eyJhbGciOiJ..." description:"token for API using Swagger (helper)"`
}
